/* $Header: /u2/lynch/misc/ruserpass.c,v 1.1 84/02/15 11:11:52 root Exp Locker: lynch $ */
/* $Log:	ruserpass.c,v $
 * Revision 1.1  84/02/15  11:11:52  root
 * Initial revision
 *  */
